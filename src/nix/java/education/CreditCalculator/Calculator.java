...
public class Calculator {
    ...
    public void countingRate(){
        ...
        loanInterest = Main.scanner.nextDouble();
    ...
    public void countingPay(){
        ...
        loanPrincipal = Main.scanner.nextDouble();
        System.out.println("Enter the number of periods:");
        numberOfMonth= Main.scanner.nextInt();
        countingRate();
    ...
    public void countingMonth(){
        System.out.println("Enter a loan principal:");
        loanPrincipal = Main.scanner.nextInt();
        System.out.println("Enter the monthly payment:");
        monthPayment = Main.scanner.nextInt();
        countingRate();
    ...
    public void  countingPrincipal(){
        System.out.println("Enter the monthly payment:");
        monthPayment = Main.scanner.nextDouble();
        System.out.println("Enter the number of periods:");
        numberOfMonth= Main.scanner.nextInt();
        countingRate();
